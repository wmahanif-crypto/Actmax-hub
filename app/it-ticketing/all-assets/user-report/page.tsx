      ...
      <div className="max-w-[210mm] mx-auto bg-white p-[15mm] shadow-2xl print:shadow-none print:w-full border border-zinc-200 print:border-none">
        ...
        <div className="flex justify-between items-center border-b-4 border-black pb-6 mb-8">
          ...
          <div className="text-right">
            <h1 className="text-2xl font-black uppercase tracking-tighter">IT Asset Issued Form</h1>
            <p className="text-[10px] text-zinc-600 font-mono italic">ACA-IT-F-001 (Rev 1)</p>
          </div>
        </div>
  ...
  <table className="w-full border-collapse border border-black text-[11px]">
    <tbody>
      ...
      <tr>
        ...
        {/* 2. Asset List Section - Buang 1 Column (Signature) */}
<section className="mb-10">
  <h3 className="font-black uppercase text-sm mb-3 flex items-center gap-2">
    <span className="bg-black text-white px-2 py-0.5 text-xs">2</span> List of Company Assets
  </h3>
  <table className="w-full border-collapse border border-black text-[11px]">
    <thead>
      ...
      {/* Table blank dah dibuang, table akan auto-cut kat sini */}
        ...
        <section className="mt-8">
          ...
          <div className="text-[10px] leading-relaxed mb-12 italic text-zinc-700">
            I, the undersigned, hereby acknowledge the receipt of the company property listed above. I understand that these assets are for professional use and I am responsible for their security and maintenance.
          </div>
